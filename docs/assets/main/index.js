  ...
  return {
    ...
    execute: function () {
      ...
      var ItemTooltipTextInspectorConfig = exports('ItemTooltipTextInspectorConfig', (_dec35 = ccclass('ItemTooltipTextInspectorConfig'), _dec36 = property({
        ...
        writable: true,
        initializer: function initializer() {
          return '武器属性：攻击 {attack} / 攻速 {speed} / 距离 {range}';
        }
        ...
        writable: true,
        initializer: function initializer() {
          return '防具属性：防御 {defense} / 魔抗 {magicResistance}';
        }
        ...
        writable: true,
        initializer: function initializer() {
          return '使用属性：冷却 {cooldown}秒 / 耗时 {useDuration}秒 / 次数 {charges}';
        }
        ...
        writable: true,
        initializer: function initializer() {
          return '材料属性：等级 {level} / 品质 {quality}';
        }
        ...
        writable: true,
        initializer: function initializer() {
          return '自定义属性：{customCategory} / {action}';
        }
      ...
      var BackpackController = exports('BackpackController', (_dec80 = ccclass('BackpackController'), _dec81 = property(Node), _dec82 = property(Button), _dec83 = property(Button), _dec84 = property({
        ...
        range: [0, 1, 0.05],
        slide: true
      }), _dec99 = property([SpriteFrame]), _dec100 = property({
        ...
        function BackpackController() {
          ...
          _initializerDefineProperty(_this, "pageTurnSound", _descriptor84, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "backpackSwitchSound", _descriptor85, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "itemClickSound", _descriptor86, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "itemSwapSound", _descriptor87, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "backpackCloseSound", _descriptor88, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "backpackOpenSound", _descriptor89, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "backpackSortSound", _descriptor90, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "soundVolume", _descriptor91, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "rarityFrames", _descriptor92, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "weaponItems", _descriptor93, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "armorItems", _descriptor94, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "consumableItems", _descriptor95, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "materialItems", _descriptor96, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "questItems", _descriptor97, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "otherItems", _descriptor98, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "dragFeel", _descriptor99, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "worldScenario", _descriptor100, _assertThisInitialized(_this));
          _this.slots = [];
          _this.inventory = [];
          ...
          _this.lastDragScreenLocation = new Vec2();
        ...
        _proto.lockDesignResolution = function lockDesignResolution() {
          var width = BackpackController.DESIGN_RESOLUTION_WIDTH;
          var height = BackpackController.DESIGN_RESOLUTION_HEIGHT;
        ...
        _proto.getItemSpecificDetailLines = function getItemSpecificDetailLines(config) {
          ...
          if (config instanceof WeaponItemConfig) {
            ...
            lines.push("\u4F7F\u7528\u5C5E\u6027\uFF1A\u51B7\u5374 " + config.cooldown + "\u79D2 / \u8017\u65F6 " + config.useDuration + "\u79D2 / \u6B21\u6570 " + config.charges);
        ...
        _proto.updateDragPageSwitch = function updateDragPageSwitch(screenLocation) {
          ...
          var overPreviousButton = (_previousTransform$hi = previousTransform == null ? void 0 : previousTransform.hitTest(screenLocation)) != null ? _previousTransform$hi : false;
          var overNextButton = (_nextTransform$hitTes = nextTransform == null ? void 0 : nextTransform.hitTest(screenLocation)) != null ? _nextTransform$hitTes : false;
        ...
        _proto.updateDragHover = function updateDragHover(screenLocation) {
          var localIndex = this.findSlotAtLocation(screenLocation);
        ...
        _proto.finishDrag = function finishDrag(screenLocation, forceReturn) {
          var _this7 = this;
          ...
          var targetLocalIndex = forceReturn ? -1 : this.findSlotAtLocation(screenLocation);
        ...
        _proto.findSlotAtLocation = function findSlotAtLocation(screenLocation) {
          for (var index = 0; index < this.slots.length; index++) {
            ...
            if (transform != null && transform.hitTest(screenLocation)) {
              return index;
            }
          }
          return -1;
      ...
      }(Component), _class21.DESIGN_RESOLUTION_WIDTH = 1280, _class21.DESIGN_RESOLUTION_HEIGHT = 720, _class21.WORLD_SCENARIO_DEFAULTS = new WorldItemScenarioConfig(), _class21), (_descriptor74 = _applyDecoratedDescriptor(_class20.prototype, "slotGrid", [_dec81], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor84 = _applyDecoratedDescriptor(_class20.prototype, "pageTurnSound", [_dec91], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor85 = _applyDecoratedDescriptor(_class20.prototype, "backpackSwitchSound", [_dec92], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor86 = _applyDecoratedDescriptor(_class20.prototype, "itemClickSound", [_dec93], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor87 = _applyDecoratedDescriptor(_class20.prototype, "itemSwapSound", [_dec94], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor88 = _applyDecoratedDescriptor(_class20.prototype, "backpackCloseSound", [_dec95], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor89 = _applyDecoratedDescriptor(_class20.prototype, "backpackOpenSound", [_dec96], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor90 = _applyDecoratedDescriptor(_class20.prototype, "backpackSortSound", [_dec97], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor91 = _applyDecoratedDescriptor(_class20.prototype, "soundVolume", [_dec98], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor92 = _applyDecoratedDescriptor(_class20.prototype, "rarityFrames", [_dec99], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor93 = _applyDecoratedDescriptor(_class20.prototype, "weaponItems", [_dec100], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor94 = _applyDecoratedDescriptor(_class20.prototype, "armorItems", [_dec101], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor95 = _applyDecoratedDescriptor(_class20.prototype, "consumableItems", [_dec102], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor96 = _applyDecoratedDescriptor(_class20.prototype, "materialItems", [_dec103], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor97 = _applyDecoratedDescriptor(_class20.prototype, "questItems", [_dec104], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor98 = _applyDecoratedDescriptor(_class20.prototype, "otherItems", [_dec105], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor99 = _applyDecoratedDescriptor(_class20.prototype, "dragFeel", [_dec106], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor100 = _applyDecoratedDescriptor(_class20.prototype, "worldScenario", [_dec107], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
